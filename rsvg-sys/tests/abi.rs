...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ("RsvgDimensionData", Layout {size: size_of::<RsvgDimensionData>(), alignment: align_of::<RsvgDimensionData>()}),
    ("RsvgError", Layout {size: size_of::<RsvgError>(), alignment: align_of::<RsvgError>()}),
    ("RsvgHandle", Layout {size: size_of::<RsvgHandle>(), alignment: align_of::<RsvgHandle>()}),
    ("RsvgHandleClass", Layout {size: size_of::<RsvgHandleClass>(), alignment: align_of::<RsvgHandleClass>()}),
    ("RsvgHandleFlags", Layout {size: size_of::<RsvgHandleFlags>(), alignment: align_of::<RsvgHandleFlags>()}),
    ("RsvgPositionData", Layout {size: size_of::<RsvgPositionData>(), alignment: align_of::<RsvgPositionData>()}),
];

const RUST_CONSTANTS: &[(&str, &str)] = &[
    ("LIBRSVG_MAJOR_VERSION", "2"),
    ("LIBRSVG_MICRO_VERSION", "16"),
